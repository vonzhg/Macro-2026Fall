...
\begin{cautionbox}[title=\textbf{And it does}]\small
Linear interpolation \textbf{preserves concavity}: the chord of a concave function lies below it, so the interpolant is concave too. Measured, the worst second difference of a linearly interpolated concave function is $4\times10^{-16}$ --- zero.
\end{cautionbox}
\medskip
\begin{takeawaybox}\footnotesize
