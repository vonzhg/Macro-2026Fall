...
\textbf{6}\newline Oct 29 &
\textbf{Heterogeneous agents I: stationary equilibria and aggregate risk.} Solving the Aiyagari model as a nested fixed point; the stationary distribution; Krusell--Smith; OLG and transition dynamics; optimal policy with heterogeneous agents, and why grids and moments break down. &
\textbf{Heterogeneous agents II: when heterogeneity aggregates.} Complete markets and Gorman aggregation; the Negishi method as the representative-agent construction; transitional dynamics by shooting, and what is lost when markets are incomplete. & HW\,2 out \\
\textbf{7}\newline Nov 5 &
...
Participation & 30\% & every session \\
\bottomrule
\end{tabularx}
\end{center}
...
There is no examination in this course. Participation carries 30\% and includes exit tickets at the end of each session, engagement in discussion and in the live demos, and your role as a discussant at the final-project conference.
...
\item[Session 6 --- Heterogeneous agents I and II]
